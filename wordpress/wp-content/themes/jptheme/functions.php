...
function jptheme_setup() {
	...
	add_image_size('jptheme-full-bleed', 2000, 1200, true);
	add_image_size('jptheme-index-img', 800, 450, true);

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'Header' => esc_html__( 'Header', 'jptheme' ),
		'Social' => esc_html__( 'Social Media Menu', 'jptheme' ),
	...
	/*Editor Styles*/
	add_editor_style( array( 'inc/editor-styles.css', 'jptheme_fonts_url()' ));	
...
register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'jptheme' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add footer widgets here.', 'jptheme' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function jptheme_scripts() {
	//Google Fonts: PT Sans and Hind
	wp_enqueue_style('jptheme-fonts', 'href="https://fonts.googleapis.com/css?family=Anton|Hind" rel="stylesheet');
	...
	wp_enqueue_script( 'jptheme-functions', get_template_directory_uri() . '/js/functions.js', array('jquery'), '20172417', true );
